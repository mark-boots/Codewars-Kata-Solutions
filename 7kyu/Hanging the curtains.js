...
const numberOfHooks = (length, maxHookDist) => length <= maxHookDist ? 2 : 2 ** Math.ceil(Math.log2(length / maxHookDist)) + 1;
//or
const numberOfHooks = (l,m)=>1+(l<=m||2**Math.ceil(Math.log2(l/m)))