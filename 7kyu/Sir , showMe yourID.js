/*
Sir , showMe yourID
https://www.codewars.com/kata/574c51aa3e4ea6de22001363/train/javascript
...
const round = (value, dec = 2) => Math.round(value * 10 ** dec) / 10 ** dec;

function sctc(sin) {
  const cos = Math.sqrt(1 - sin * sin);
  const tan = cos ? round(sin / cos) : null;
  const cot = sin ? round(cos / sin) : null;
