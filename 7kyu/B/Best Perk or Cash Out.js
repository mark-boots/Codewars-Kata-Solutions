/*
Best Perk or Cash Out
https://www.codewars.com/kata/69347c0454f16273e13b56e8/train/javascript
...
pick=(p,b,o)=>(o.map(([s,v],i)=>[s,v,'ABC'[i]]).filter(([s])=>!b.has(s)).sort((a,b)=>p.has(b[0])-p.has(a[0])||b[1]-a[1])[0]||[,,'D'])[2]
