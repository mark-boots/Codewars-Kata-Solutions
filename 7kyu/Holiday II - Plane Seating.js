...
const planeSeat = a => {
    const x = ['Front','Middle','Back'][Math.floor((a.slice(0,a.length-1)-1)/20)]
    const y = ['Left','Middle','Right'][['ABC','DEF','GHK'].findIndex(v=>v.includes(a.slice(-1)))]
    return x && y ? x+'-'+y : 'No Seat!!'
}
