...
drawLines=(p,s=100,c=new Canvas(s,s),x=c.getContext('2d'))=>{
  x.fillStyle="#fff",x.fillRect(0,0,s,s),x.strokeStyle="#f00",x.beginPath(),x.moveTo(p[0][0],p[0][1])
  for(i=1;i<p.length;i++)x.lineTo(p[i][0],p[i][1])
  x.stroke();return c.toDataURL();
}