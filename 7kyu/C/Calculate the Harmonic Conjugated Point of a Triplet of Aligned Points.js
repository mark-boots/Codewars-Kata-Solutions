...
https://www.codewars.com/kata/5600e00e42bcb7b9dc00014e/train/javascript
...
function harmonPointTrip(xA, xB, xC) {
  let xD = (xB * xC - xA * xA) / (2 * xB - xA - xC);
  return xD.toFixed(2);
}

harmonPointTrip=(a,b,c)=>((2*a*b-a*c-b*c)/(a+b-2*c)).toFixed(2)