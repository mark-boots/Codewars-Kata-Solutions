...
https://www.codewars.com/kata/589a9aadc4e27877cb000027/train/javascript
...
function companyBotStrategy(trainingData) {
  const correctAnswers = trainingData.filter(([_, correctNess]) => correctNess == 1);
  return correctAnswers.reduce((total, [answerTime, _]) => total + answerTime, 0) / correctAnswers.length || 0;
}