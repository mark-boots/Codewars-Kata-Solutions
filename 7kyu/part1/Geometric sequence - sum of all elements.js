...
function geometricSequenceSum(a, r, n) {
  if (r === 1) {
    return a * n; // If r is 1, the sum is simply a multiplied by n
  }
  return a * (1 - Math.pow(r, n)) / (1 - r); // Geometric series sum formula
}

//

GeometricSequenceSum=(a,r,n)=>a*(r**n-1)/(r-1)||a*n;