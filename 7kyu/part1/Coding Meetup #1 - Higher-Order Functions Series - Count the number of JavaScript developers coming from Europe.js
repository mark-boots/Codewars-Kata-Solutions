...
const countDevelopers = list => list.filter(o=>o.continent=='Europe' && o.language=='JavaScript').length
...
const countDevelopers = list => {
    ...
    return list.filter(o => Object.keys(filters).every(k=>o[k] == filters[k])).length
}