...
ou are the Dungeon Master for a public DnD game at your local comic shop and recently you've had some trouble keeping your players' info neat and organized so you've decided to write a bit of code to help keep them sorted!
...
playerManager=p=>p?p.split(/(?<=\d), /).map(s=>([a,b]=s.split`,`,{player:a,contact:+b})):[]