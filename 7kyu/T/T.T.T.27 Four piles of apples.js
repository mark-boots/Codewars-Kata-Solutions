...
function fourPiles(n, y) {
  return (x = n * y / (y + 1) ** 2) % 1 || x-y == 0 ? [] : [x + y, x - y, x * y, x / y]
}

fourPiles=(n,y,x=n*y/(y+1)**2,p=[x+y,x-y,x*y,x/y])=>x%1||p.some(v=>v<1)?[]:p

fourPiles=(n,y,x=n*y++/y/y--)=>x<=y||x%y?[]:[x+y,x-y,x*y,x/y]
