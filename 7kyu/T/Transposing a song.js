...
ou are a composer who just wrote an awesome piece of music. Now it's time to present it to a band that will perform your piece, but there's a problem! The singers vocal range doesn't stretch as your piece requires, and you have to transpose the whole piece.
...
N="A,A#|Bb,B,C,C#|Db,D,D#|Eb,E,F,F#|Gb,G,G#|Ab".split`,`.map(v=>v.split`|`)
transpose=(s,i)=>s.map(n=>N[(N.findIndex(a=>a.includes(n))+i+12)%12][0])