/*
Mew Cipher
https://www.codewars.com/kata/671bd5419ea261fbb8d0a0ca/train/javascript
...
decipher=(c,x=' abcdefghijklmnopqrstuvwxyz')=>[...c[0]].reduce((s,_,i)=>s+x[(c.reduce((t,r)=>t+x.indexOf(r[i]),0)/c.length)|0],``)