...
const s = { Monday: 'James', Tuesday: 'John', Wednesday: 'Robert', Thursday: 'Michael', Friday: 'William' }
const task = (w,n,c) => `It is ${w} today, ${s[w]}, you have to work, you must spray ${n} trees and you need ${n*c} dollars to buy liquid`