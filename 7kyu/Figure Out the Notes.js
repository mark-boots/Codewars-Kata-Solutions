...
const N = 'E-F-F#-G-G#-A-A#-B-C-C#-D-D#'.split`-`;
const S = [...'EADGB'].reduce((obj,val)=>(i=N.indexOf(val),Object.assign(obj,{[val]:[...N.slice(i),...N.slice(0,i)]}),obj),{})      
const whatNote = (string, fret) => S[string.toUpperCase()][fret%12]

//or

const whatNote = (s,f,N='E-F-F#-G-G#-A-A#-B-C-C#-D-D#'.split`-`)=>N[(N.indexOf(s.toUpperCase())+f)%12]